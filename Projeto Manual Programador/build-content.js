...
// carregado à parte.
//
// Rodar `node build-content.js` (dentro de Projeto Manual Programador/)
// sempre que um arquivo de content/*.html for criado ou editado.
// (mesmo script de Projeto Manual/build-content.js — copiado, não linkado,
// pra cada ferramenta poder evoluir o próprio pipeline sem acoplar as duas)
const fs = require('fs');
