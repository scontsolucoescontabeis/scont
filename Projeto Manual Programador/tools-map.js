...
window.MANUAL_GRUPOS = [
    {
        ...
        icone: '🕐',
        prefixos: ['./projeto rh/index.html', './projeto departamento pessoal/'],
    },
    {
        slug: 'rh-lancamentos',
        nome: 'Lançamentos de Folha',
        icone: '📋',
        prefixos: ['./projeto rh/lancamentos.html', './projeto departamento pessoal/'],
    },
    {
        slug: 'rh-admin',
        nome: 'Administração RH',
        icone: '⚙️',
        prefixos: ['./projeto departamento pessoal/configuracoes.html', './projeto departamento pessoal/'],
    },
    {
    ...
    },
    {
        ...
        icone: '📅',
        prefixos: ['./projeto calendario folha/', './projeto departamento pessoal/'],
    },
    {
        slug: 'fechamento-folha',
        nome: 'Fechamento de Folha',
        icone: '📊',
        prefixos: ['./projeto fechamento folha/', './projeto departamento pessoal/'],
    },
    {
        slug: 'simulador-folha',
        nome: 'Simulador de Folha de Pagamento',
        icone: '🧮',
        prefixos: ['./projeto simulador folha/', './projeto departamento pessoal/'],
    },
    {
