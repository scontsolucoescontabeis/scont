-- ============================================================
-- Registra a ferramenta "Triagem de Atendimentos" no portal
...
VALUES
    ('Triagem de Atendimentos',
     'Visualiza e organiza as conversas Pendentes e Em Atendimento extraídas do Gestta Messenger',
     '🎯', './Projeto Triagem/index.html', TRUE, 150)
