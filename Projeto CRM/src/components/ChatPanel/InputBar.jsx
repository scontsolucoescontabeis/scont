...
import { PickerMensagensProntas } from './PickerMensagensProntas'
...
export function InputBar({ onEnviar, onAnotacao, disabled }) {
  ...
  const handleSelecionarPronta = (conteudo) => {
    setTexto(conteudo)
  ...
  return (
    <div style={{ borderTop: '1px solid #e0dcd8', background: '#fff' }}>
      {/* Picker de mensagens prontas — abre acima da barra de input */}
      {mostrarPicker && (
        <PickerMensagensProntas
          onSelecionar={handleSelecionarPronta}
        ...
        <div style={{ display: 'flex', gap: 6, marginBottom: 8 }}>
          ...
          <button
            ...
            style={{
              ...
              fontSize: 11, fontWeight: 500, cursor: 'pointer',
              marginLeft: 'auto',
              borderColor: mostrarPicker ? '#7a1e1e' : '#e0dcd8',
              background: mostrarPicker ? '#f0e8e8' : '#fff',
              color: mostrarPicker ? '#7a1e1e' : '#888480',
            }}
          >
            <BookOpen size={11} />
            Prontas
